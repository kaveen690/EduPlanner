          ...
          <div className="flex items-center gap-3">
            {mode === 'profile' ? (
              <>
                ...
                <h3 className="text-base font-bold">Academic User Profile</h3>
              </>
            ) : (
              <div className="flex items-center gap-3">
                {/* Premium Gradient Logo Badge */}
                <div className="relative flex items-center justify-center w-9 h-9 p-1.5 rounded-xl bg-gradient-to-tr from-[#2563EB] via-[#7C3AED] to-[#06B6D4] text-white shadow-lg shadow-blue-500/25 border border-white/20 shrink-0">
                  <div className="relative flex items-center justify-center w-full h-full">
                    <BookOpen className="w-3.5 h-3.5 text-cyan-200/90 absolute bottom-0.5" />
                    <GraduationCap className="w-4 h-4 text-white absolute -top-0.5" />
                    <Cpu className="w-2.5 h-2.5 text-cyan-300 absolute -top-1 -right-1 animate-pulse" />
                  </div>
                </div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="px-1.5 py-0.5 rounded-md bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-400 text-white font-extrabold text-[10px] uppercase tracking-wider shadow-sm">
                    AI
                  </span>
                </div>
              </div>
